...
<AccordionGroup>
  ...
  <Accordion title="Alerting">
    Set up alerts for critical metrics: * High error rates (eg: 5xx responses,
    transaction failures) * API rate limit nearly exhausted * Unexpected latency
    spikes * Discrepancies in data (eg: prices, balances)
  </Accordion>
</AccordionGroup>

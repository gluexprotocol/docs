...
# GlueX Yield Router API

A yield router is a specialized API service that analyzes and calculates Annual Percentage Yield (APY) across different DeFi protocols and liquidity pools. The GlueX Yield Router API provides developers with accurate, dilution-aware yield calculations that account for the real impact of capital deployment on returns.
